...
mobs:register_mob(
	"draconis:jungle_wyvern",
	{
		...
		drops = {
			{name = draconis.meat_raw_id, chance = 1, min = 3, max = 5}
		},
		visual = "mesh",
		visual_size = {x = 3, y = 3},
...
minetest.register_node(
	"draconis:jungle_wyvern_egg",
	{
		...
		on_construct = function(pos)
			...
			local dirt_with_rainforest_litter = draconis.game_core_prefix .. ":dirt_with_rainforest_litter"
			if nest.name == dirt_with_rainforest_litter then
...
mobs:spawn(
	{
		name = "draconis:jungle_wyvern",
		nodes = draconis.game_core_prefix .. ":dirt_with_rainforest_litter",
		neighbours = "air",
		min_light = 14,
		interval = 100,
